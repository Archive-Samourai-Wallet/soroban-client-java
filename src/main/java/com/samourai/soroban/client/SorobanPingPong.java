...
public class SorobanPingPong {
  ...
  public static void initiator(RpcClient rpc, String directoryName, int numIter) throws Exception {
    if (log.isDebugEnabled()) {
      log.debug("Connecting initiator...");
    }
    RpcDialog dialog = RpcDialog.initiator(rpc, directoryName);
  ...
  public static void contributor(RpcClient rpc, String directoryName, int numIter)
      throws Exception {
    if (log.isDebugEnabled()) {
      log.debug("Connecting contributor...");
    }
    RpcDialog dialog = RpcDialog.contributor(rpc, directoryName);
