...
public class SorobanService {
  ...
  public SorobanService(
      BIP47UtilGeneric bip47Util, NetworkParameters params, RpcClientService rpcClientService) {
        ...
        new Thread(
            () -> {
              ...
              try {
                ...
                dialogOrNull = rpcClient.createRpcDialog(rpcWallet, initialDirectory);
